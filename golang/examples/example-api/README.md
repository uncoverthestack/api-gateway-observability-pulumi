...
- 2 Lambda functions (Node.js runtime Lambda runtime is independent of Pulumi language)
...
```bash
# From the golang/examples/example-api folder
go mod tidy
...
PLEASE NOTE: This is an example deployment for testing only do not use these endpoints in production.
